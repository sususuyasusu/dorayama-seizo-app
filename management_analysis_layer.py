...
CLOSE_CHECKLISTS = {
    "8月": [
        ...
        {"item": "内部人件費の確定", "state": "社内対応", "detail": "8/25の給与一括振込が帳簿に入ったが、社員・アルバイト・デザイン部の内訳が未確認（管理会計PL上は約271万円と過大）。給与確定額1,314,804円とシフト原価1,773,251円の整合・社会保険の会社負担配賦も残る"},
